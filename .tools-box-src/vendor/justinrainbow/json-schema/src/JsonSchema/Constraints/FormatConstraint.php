...
use _HumbugBoxb47773b41c19\JsonSchema\Rfc3339;
class FormatConstraint extends Constraint
{
    ...
    {
        if (\in_array(\strtolower($color), array('aqua', 'black', 'blue', 'fuchsia', 'gray', 'green', 'lime', 'maroon', 'navy', 'olive', 'orange', 'purple', 'red', 'silver', 'teal', 'white', 'yellow'))) {
            return \true;
        }
