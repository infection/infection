...
use _HumbugBoxb47773b41c19\JsonSchema\Exception\ValidationException;
...
class BaseConstraint
{
    ...
    {
        $error = array('property' => $this->convertJsonPointerIntoPropertyPath($path ?: new JsonPointer('')), 'pointer' => \ltrim(\strval($path ?: new JsonPointer('')), '#'), 'message' => $message, 'constraint' => $constraint, 'context' => $this->factory->getErrorContext());
