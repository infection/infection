...
namespace _HumbugBoxb47773b41c19\Composer;

use _HumbugBoxb47773b41c19\Composer\Autoload\ClassLoader;
use _HumbugBoxb47773b41c19\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_HumbugBoxb47773b41c19\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
