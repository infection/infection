...
use _HumbugBoxb47773b41c19\Safe\Exceptions\LibeventException;
...
{
    \error_clear_last();
    $result = \_HumbugBoxb47773b41c19\event_base_reinit($event_base);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \_HumbugBoxb47773b41c19\event_priority_set($event, $priority);
    if ($result === \false) {
        throw LibeventException::createFromPhpError();
    }
}
