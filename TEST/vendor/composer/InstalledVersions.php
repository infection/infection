...
namespace _HumbugBox9658796bb9f0\Composer;

use _HumbugBox9658796bb9f0\Composer\Autoload\ClassLoader;
use _HumbugBox9658796bb9f0\Composer\Semver\VersionParser;
    ...
    */
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_HumbugBox9658796bb9f0\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
