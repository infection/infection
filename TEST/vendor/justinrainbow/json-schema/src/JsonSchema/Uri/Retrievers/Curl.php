...
use _HumbugBox9658796bb9f0\JsonSchema\Exception\RuntimeException;
...
class Curl extends AbstractRetriever
{
    ...
    public function retrieve($uri)
    {
        ...
        if (\false === $response) {
            throw new \_HumbugBox9658796bb9f0\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
