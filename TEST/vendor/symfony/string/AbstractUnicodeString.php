...
use _HumbugBox9658796bb9f0\Symfony\Component\String\Exception\ExceptionInterface;
use _HumbugBox9658796bb9f0\Symfony\Component\String\Exception\InvalidArgumentException;
use _HumbugBox9658796bb9f0\Symfony\Component\String\Exception\RuntimeException;
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    public function snake() : parent
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], '_HumbugBox9658796bb9f0\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
